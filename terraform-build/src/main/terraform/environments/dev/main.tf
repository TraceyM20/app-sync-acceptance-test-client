...
module "main" {
  ...
  environment_remote_state_bucket_arn = "arn:aws:s3:::vts-nep-dev-terraform-remote-state"
  environment_remote_state_table_arn  = "arn:aws:dynamodb:ap-southeast-2:794701946555:table/vts-nep-dev-terraform-remote-state"
  ...
  release_bucket_arn                  = "arn:aws:s3:::vts-nep-dev-release-artifacts"
  release_bucket_name                 = "vts-nep-dev-release-artifacts"
  ...
  iam_profile                         = {
    ...
    source_profile = "VTS-NEP-Development"
    profile_name   = "nep-dev-support"
  }
  ...
  acceptance_parameter_store_values = {
    ...
    "service/configuration-base-path" = {
      value = "/vts-nep-new-project-template/dev/"
      type  = "String"
    }
    ...
    "service.base-url"                = {
      value = "https://api.dev.nep.vts.nz/service/new-project-template"
      type  = "String"
    }
    "cognito.url"                     = {
      value = "https://api.dev.nep.vts.nz/service/security"
      type  = "String"
    }
  }
  ...
  application_domain_name           = "new-project-template.origin.dev.nep.vts.nz"
  ...
  application_web_acl_arn           = "arn:aws:wafv2:ap-southeast-2:794701946555:regional/webacl/vts-nep-temp-dev-access-control/536f594e-f9ca-4347-8b83-696ad702d863"
}
